  ...
  <div>
    ...
    <div id="section-2">
      <div class="grid grid-cols-3 text-center px-20 py-10 bg-yellow-500 gap-10">
        <div>
          ...
          <h2 class="uppercase font-oswald font-medium text-2xl py-5">
            Original Recipes
          </h2>
          <p class="font-light">
            We use our secret recipes and only the best ingredients to make our burgers.
        ...
        <div>
          ...
          <h2 class="uppercase font-oswald font-medium text-2xl py-5">Quality Foods</h2>
          <p class="font-light">
            We purchase our ingredients from the best suppliers daily, to ensure the
            frehest quality of our burgers.
          </p>
        </div>
        <div>
          <svg
    ...
    <div id="section-3" class="text-center">
      ...
      >
        ...
        <div
          class="col-span-7 bg-cover bg-center bg-[url('/burger-bg-1.jpg')] text-right pt-10 pr-10"
        >
          <h4>
            Crispy <br />
            Chicken
      ...
      <div id="section-4" class="px-20 text-left bg-gray-100 py-20">
        <div class="grid grid-cols-2">
          <img src="about.png" alt="" class="pl-20" />
          <h3 class="font-oswald uppercase text-5xl pl-20 pr-4 pt-10 leading-snug">
        ...
        <p class="text-lg text-gray-500 mt-10">
          ...
          operated business, and we're proud to bea part of the community.We do our best
          to make sure that everyone's happy and having a good time.
        </p>
        <p class="text-lg text-gray-500 mt-10">
          Burger are what brought us together and what keep us together. It's something
          that you can't put a price tag on. More importantly, we are interedted in
          people. It's not just about the food.
        </p>
      </div>

      <div id="section-5" class="grid grid-cols-5 text-left bg-yellow-500 text-amber-900">
        <div class="col-span-3 pl-20 pt-16 pb-16">
          ...
          <p class="text-lg my-7">
            ...
            Enjoy the convenience of ordering food online at any time and from any
            location.
          </p>
